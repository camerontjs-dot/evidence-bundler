...
TMP_DIR="$(mktemp -d "${TMPDIR:-/tmp}/eb-v1-rc1-v3.XXXXXX")"
trap 'rm -rf "$TMP_DIR"' EXIT
CORRECTED_COBALT_RUBRIC="$TMP_DIR/OPERATIONAL_REVIEW_RUBRIC_COBALT_V3.md"
TMP_RUNNER="$TMP_DIR/run_rc1_with_codex_v3_inner.sh"
...
print('APPARATUS_V3_IDENTITY_VALID')
